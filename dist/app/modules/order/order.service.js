...
const orderCreate_DB = (order) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield order_model_1.Order.create(order);
    return result;
});
// get all order data method
const orderGetAll_DB = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield order_model_1.Order.find();
    return result;
});
// get all orders by email method
const orderGetAllByEmail_DB = (email) => __awaiter(void 0, void 0, void 0, function* () {
